...
class Transitioner extends React.Component {
  ...
  startTransition(props, nextProps) {
...
buildTransitionProps = (props, state) => {
...
const isSceneNotStale = (scene) => {
  return !scene.isStale;
}

const filterStale = (scenes = []) => {
